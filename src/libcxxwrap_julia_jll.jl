baremodule libcxxwrap_julia_jll
    ...
    const libcxxwrap_julia = "$(Base.DEPOT_PATH[1])/artifacts/$artifact_git_tree_sha1/lib/libcxxwrap_julia.so"
    const libcxxwrap_julia_path = libcxxwrap_julia
    const libcxxwrap_julia_stl = "$(Base.DEPOT_PATH[1])/artifacts/$artifact_git_tree_sha1/lib/libcxxwrap_julia_stl.so"
end
